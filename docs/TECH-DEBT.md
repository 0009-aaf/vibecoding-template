...
| 2026-08-23 | `AGENTS.md`（根） | 滞后于文档体系：未引用 constitution.md、核心文档清单缺 00/04-09/TECH-DEBT、切片路径口径与 vibe-spec 产出不一致 | 新会话 AI 以根 AGENTS 为入口拿到过时视图 | 下次修订 AGENTS 时对齐 starter 版结构 |
